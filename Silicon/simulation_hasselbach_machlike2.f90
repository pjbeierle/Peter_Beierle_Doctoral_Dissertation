...
!====================================================================
		...
		OPEN(UNIT=13,FILE='debug.dat')
                OPEN(UNIT=14,FILE='electrondistribution_machlike_ub'//trim(x1)//'.dat')
                OPEN(UNIT=15,FILE='off_diagonal_dist_machlike_ub'//trim(x1)//'.dat')
...
f=(4.13d0+4.59d0)/500d0 		!500 time steps (change as necessary)
Pi=3.14159265d0
