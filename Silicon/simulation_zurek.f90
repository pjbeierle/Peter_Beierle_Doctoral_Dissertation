PROGRAM Euler
!        
!       calculates electron motion above surface with image charge and figure of merit for decoherence
!
	IMPLICIT NONE
	...
	real*8 binlower(Nbin),binupper(Nbin),binposition(Nbin)
		...
		OPEN(UNIT=14,FILE='electrondistribution_zurek7b.dat')
		OPEN(UNIT=15,FILE='off_diagonal_dist_zurek7b.dat')
